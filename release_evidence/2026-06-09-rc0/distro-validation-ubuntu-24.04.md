...
Install Path: local the build environment release build (non-systemd install path for this transcript)
...
- [x] baseline software gate (`./test.sh --all`) passed in same session
